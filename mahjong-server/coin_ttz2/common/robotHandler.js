...
exports.qiangZhuang = function(userId,data){
    ...
    var pokerType = gameLogic.getMJType(player.hold);
    //根据牌型选择抢庄倍数
    //无牛尽量不选
...
exports.yaZhu = function(userId){
    ...
    if(0<=pokerType&&pokerType<6){
        yaZhuBeiShu = commonUtil.randomFrom(1,3);
    }else if(6<pokerType&&pokerType<10){
        yaZhuBeiShu = commonUtil.randomFrom(3,5);
    }else{
        yaZhuBeiShu = commonUtil.randomFrom(5,8);
    }
