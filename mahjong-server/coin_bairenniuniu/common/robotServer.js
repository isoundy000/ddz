...
var config = require('../../configs').coinBRNN();
 ...
 */
exports.start = function (intervalTime,room_config) {
...
function scanRoom() {
    ...
    // console.log(`机器人获取房间列表`);console.log(roomList)
...
function enterRoom(roomId,delayTime){
    setTimeout(async function(){
        ...
        //根据房间的底注初始化机器人携带的金币量
        var minScore = roomInfo.minScore;
        let coins = commonUtil.randomFrom(minScore,roomInfo.maxScore)
        console.log("机器人的金币"+coins)
